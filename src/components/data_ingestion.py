...
class DataIngestion:
    def __init__(self, data_ingestion_config: DataIngestionConfig):
        try:
            ...
            logging.error(
                f"Error occurred in data ingestion object creation due to {CustomException(e,sys)}"
            )
    ...
    def download_image_data(self) -> Path:
        try:
            ...
            logging.error(
                f"Downloading data interrupted due to {CustomException(e,sys)}"
            )
            raise CustomException(e, sys)
